...
export default function Tentang() {
    return (<div className="edu-body"> <Header /> <div className="edu-content"> <TypingText text="TENTANG JANGANKLIK!"
        ...
        suffix="%"/> </div> <div className="threat-label">Korban Muda</div> <div className="threat-desc">Gen Z & Milenial</div> </div> </div> </div> <div className="impact-statement"> <div className="impact-content"> <h4>DAMPAK YANG INGIN DICAPAI</h4> <p><strong>JanganKlik !</strong> hadir untuk mengubah statistik tersebut melalui pendekatan edukasi yang revolusioner - bukan lagi teori kering, tapi pengalaman interaktif yang benar-benar berdampak.</p> <div className="warning-callout"> <div className="warning-icon"> <i className="ri-error-warning-line"></i> </div> <div className="warning-content"> <h5>⚠️ PENGINGAT KRITIS</h5> <p>Sesuai dengan nama portal ini <strong>"JanganKlik"</strong>, jika Anda masih sering mengklik tautan mencurigakan, membuka file dari sumber tidak dikenal, atau memberikan data pribadi dengan mudah - maka Anda merupakan target empuk bagi para kriminal siber.</p> <p><strong>Jangan sampai Anda menjadi korban berikutnya !</strong> Portal ini hadir untuk melatih Anda mengenali dan menghindari jebakan digital yang semakin canggih.</p> </div> </div> </div> </div> <h2 className="section-title">Fitur Utama</h2> <h3>Data Fakta</h3> <p> Statistik terkini tentang kondisi keamanan siber di Indonesia, berdasarkan sumber terpercaya seperti BSSN dan APJII. </p> <h3>Edukasi Komprehensif</h3> <p> Panduan lengkap tentang berbagai jenis ancaman siber: </p> <ul> <li><strong>Phishing & APK Scam</strong> - Modus penipuan melalui tautan dan file berbahaya</li> <li><strong>Social Engineering</strong> - Manipulasi psikologis untuk mendapatkan data</li> <li><strong>Password Hygiene</strong> - Manajemen kata sandi yang aman</li> <li><strong>Emergency Response</strong> - Langkah-langkah jika terlanjur menjadi korban</li> </ul> <h3>Simulasi Interaktif</h3> <p> Pengalaman belajar yang unik melalui simulasi chat phishing. Uji kemampuan Anda mengenali penipuan dalam skenario nyata yang sering terjadi di Indonesia. </p> <h2 className="section-title">Tim Pengembang</h2> <div className="team-section"> <div className="team-member"> <div className="member-avatar"> <i className="ri-user-line"></i> </div> <h4>Husnul Khotimah</h4> <p>Developer & Cybersecurity Enthusiast</p> </div> <div className="team-member"> <div className="member-avatar"> <i className="ri-user-line"></i> </div> <h4>Salsabila</h4> <p>Developer & UI/UX Designer</p> </div> </div> <p className="team-description"> Portal ini dikembangkan oleh tim yang passionate tentang keamanan siber dan edukasi digital. Kami percaya bahwa pengetahuan adalah pertahanan terbaik terhadap ancaman siber. </p> <h2 className="section-title">Hubungi Kami</h2> <div className="contact-section"> <p> Punya pertanyaan, saran, atau ingin berkontribusi? Kami terbuka untuk diskusi dan kolaborasi. </p> <div className="contact-info"> <div className="contact-item"> <i className="ri-mail-line"></i> <div> <h4>Email</h4> <a href="mailto:husulkhotimah110106@gmail.com">husulkhotimah110106@gmail.com</a> </div> </div> </div> </div> </div> <Footer /> </div>);
}
