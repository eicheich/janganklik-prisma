  ...
  return (<> {
    ...
    <header id="hero"> {
      ...
      <div className="hero-content"> {
        ...
        <HackerText text="ARE YOU SAFE?" className="hacker-text" /> {
          " "
        }
        ...
        <p> {
          ...
          Di tahun 2024, Indonesia mengalami <strong>1.2 Miliar+</strong> {
            " "
          }

          anomali trafik siber. Jangan jadi korban berikutnya. {
            " "
          }
        ...
        <a href="/education#emergency" className="btn-emergency" style={{
          borderRadius: '50px',
          padding: '15px 40px',
          ...
          <i className="ri-alarm-warning-line"></i> I&apos;M NOT SAFE
        </a>
    ...
    <div className="marquee-wrapper"> {
      ...
      <div className="marquee-content"> {
        ...
        DATA PRIVACY • WASPADA PHISHING • STOP PINJOL ILEGAL • SARING SEBELUM SHARING • KENALI MODUS SIBER • DATA PRIVACY • WASPADA PHISHING • STOP PINJOL ILEGAL • SARING SEBELUM SHARING • KENALI MODUS SIBER • DATA PRIVACY • WASPADA PHISHING • STOP PINJOL ILEGAL • SARING SEBELUM SHARING • KENALI MODUS SIBER • {
          " "
        }
