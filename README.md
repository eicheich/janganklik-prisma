...
│ /simulation   │   │  /ai-checker  │   │  /education   │
└───────┬───────┘   └───────────────┘   └───────────────┘
        │
        ▼
┌─────────────────────────────────────────────────────────────────┐
│                    PILIH SKENARIO                                │
│  10 Skenario penipuan yang bisa dipilih:                        │
│  1. Phishing APK        6. Fake Login (Browser)                 │
│  2. Voice Phishing      7. Scareware Popup                      │
│  3. Deepfake Video      8. Email Phishing                       │
│  4. Giveaway Bodong     9. Pinjol Ilegal                        │
│  5. E-commerce Fraud   10. Social Media Scam                    │
└───────────────────────────┬─────────────────────────────────────┘
                            │
                            ▼
┌─────────────────────────────────────────────────────────────────┐
│                    GAMEPLAY SIMULASI                             │
│  - Tampilan mockup HP/Browser realistis                         │
│  - Interaksi: Klik jebakan atau pilih aksi aman                 │
│  - Audio/Video untuk simulasi telepon & video call              │
│  - Feedback: AMAN ✅ atau BAHAYA ❌                              │
│  - Penjelasan edukasi setelah selesai                           │
└─────────────────────────────────────────────────────────────────┘
```
...
### Simulasi - Pilih Skenario
![Simulasi](docs/screenshots/simulation.png)

### Gameplay - Voice Phishing
![Voice Phishing](docs/screenshots/voice-phishing.png)

### Gameplay - Deepfake Video Call
![Deepfake](docs/screenshots/deepfake.png)

### AI Link Checker
![AI Checker](docs/screenshots/ai-checker.png)
